#!/bin/bash
# ===================== CLIP_VG Comprehensive Test Script =====================
# Automatically test all dataset and modality combinations
# Usage: bash run_all_clip_vg_tests.sh

echo "Starting CLIP_VG comprehensive test..."
echo "Test scope:"
...
for dataset in "${DATASETS[@]}"; do
    for modality in "${MODALITIES[@]}"; do
        ...
        echo "   Output: ./visual_result/clip_vg/$dataset/$modality"
        echo "----------------------------------------"
...
echo ""
echo "CLIP_VG comprehensive test completed!"
echo "========================================"
...
echo "   - To modify sample count, edit NUM_SAMPLES in visualize_clip_vg.sh"
