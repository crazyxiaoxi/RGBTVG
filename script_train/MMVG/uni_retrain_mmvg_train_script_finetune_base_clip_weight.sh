...
bash ./script_train/MMVG/rgbtvg_flir/uni_retrain_mmvg_single_dataset_flir_finetune_base_clip_weight.sh
bash ./script_train/MMVG/rgbtvg_m3fd/uni_retrain_mmvg_single_dataset_m3fd_finetune_base_clip_weight.sh
bash ./script_train/MMVG/rgbtvg_mfad/uni_retrain_mmvg_single_dataset_mfad_finetune_base_clip_weight.sh
bash ./script_train/MMVG/rgbtvg_mixup/uni_retrain_mmvg_mixup_dataset_finetune_base_clip_weight.sh
