...
# 训练参数
TRAIN_ARGS=(--num_workers 4 --modality $MODALITY --batch_size $BATCHSIZE --imsize $IMGSIZE --epochs $EPOCHS --lr_bert 0.00001  cosine --aug_crop --aug_scale --aug_translate --vl_hidden_dim 512 --max_query_len 77)
# 评估参数
...
for DATA_SET in "${OTHER_DATASETS[@]}"; do
    ...
    EVAL_MODEL_PATH="./output_training/CLIP_VG_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST/best_checkpoint.pth"
    OUTPUT_DIR="./output_training/CLIP_VG_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST"
    mkdir -p $OUTPUT_DIR
