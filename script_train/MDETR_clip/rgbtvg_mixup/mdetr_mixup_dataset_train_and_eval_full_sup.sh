...
EVAL_MODEL_PATH="./output_training/MDETR_clip_$MODALITY/$DATA_SET/best_checkpoint.pth"
OUTPUT_DIR="./output_training/MDETR_clip_$MODALITY/$DATA_SET"
...
for DATA_SET in "${OTHER_DATASETS[@]}"; do
    ...
    EVAL_MODEL_PATH="./output_training/MDETR_clip_$MODALITY/$DATA_SET_TEST/best_checkpoint.pth"
    OUTPUT_DIR="./output_training/MDETR_clip_$MODALITY/$DATA_SET_TEST"
    mkdir -p $OUTPUT_DIR
