...
for DATA_SET in "${OTHER_DATASETS[@]}"; do
    ...
    EVAL_MODEL_PATH="./output_training/TransVG_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST/best_checkpoint.pth"
    OUTPUT_DIR="./output_training/TransVG_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST"
    mkdir -p $OUTPUT_DIR
