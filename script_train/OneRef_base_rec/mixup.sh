...
EVAL_MODEL_PATH="./output_training/ONEREF_base_rec_${IMGSIZE}_${MODALITY}/$DATA_SET/best_checkpoint.pth"
...
for DATA_SET in "${OTHER_DATASETS[@]}"; do
    ...
    EVAL_MODEL_PATH="./output_training/ONEREF_rec_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST/best_checkpoint.pth"
    OUTPUT_DIR="./output_training/ONEREF_rec_${IMGSIZE}_${MODALITY}/$DATA_SET_TEST"
    mkdir -p $OUTPUT_DIR
