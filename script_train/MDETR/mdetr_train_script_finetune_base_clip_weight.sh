...
# stdbuf -oL -eL bash ./script_train/MDETR/rgbt_flir/mdetr_single_dataset_flir_train_and_eval_full_sup.sh 2>&1 | tee logs/mdetr/$MODALITY/flir_train.log

echo "===== Start M3FD training ====="
# stdbuf -oL -eL bash ./script_train/MDETR/rgbt_m3fd/mdetr_single_dataset_m3fd_train_and_eval_full_sup.sh 2>&1 | tee logs/mdetr/$MODALITY/m3fd_train.log
