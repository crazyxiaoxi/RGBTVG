...
# ReferItGame
python -m torch.distributed.launch --nproc_per_node=8 --use_env --master_port 28887 mmca_eval.py --batch_size 32 --num_workers 4 --bert_enc_num 12 --detr_enc_num 6 --backbone resnet50 --dataset rgbtvg_flir --max_query_len 20 --eval_set test --eval_model ../released_models/TransVG_referit.pth --output_dir ./outputs/referit_r50
