...
def main(args):
    ...
    if args.retrain:
        ...
        # merged_clip_part = model_without_ddp.clip.base_model.merge_and_unload()
        # new_checkpoint = checkpoint
        # new_checkpoint['model'] = model.state_dict()
        # FINAL_VG_MODEL_SAVE_PATH = "../dataset_and_pretrain_model/pretrain_model/pretrained_weights/MMVG/mixup_pretraining_base/mixup/merged_fixed_best_checkpoint.pth"
        # torch.save(new_checkpoint, FINAL_VG_MODEL_SAVE_PATH)
        #################
        print("best_accu: ", best_accu)
