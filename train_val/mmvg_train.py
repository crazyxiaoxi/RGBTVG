...
def get_args_parser():
    ...
    parser.add_argument('--open_lora', default=True, type=str)
    parser.add_argument('--open_text_guided_fusion', default=True, type=str)
...
# 'clip.base_model.model.base_model.model.base_model.model.base_model.model.logit_scale', 'clip.base_model.model.base_model.model.base_model.model.base_model.model.text_model.embeddings.position_ids',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch==60:
            model.module.args.hi_lora_stage=1
            model.module.set_HiLoRA(model.module.args)
        if epoch==80:
            model.module.args.hi_lora_stage=2
            model.module.set_HiLoRA(model.module.args)
        if epoch==100:
            model.module.args.hi_lora_stage=3
            model.module.set_HiLoRA(model.module.args)
