...
# clip.base_model.model.vision_model.encoder.layers.1.self_attn.v_proj.lora_A.default.weight
    ...
    if utils.is_main_process():
        ...
        if args.eval_out_dir and utils.is_main_process():
            with (eval_out_dir / "eval_{}_{}_{}_{}_log.txt".format(args.dataset, args.model_name, args.imsize, args.modality)).open("a") as f:
                f.write(json.dumps(log_stats) + "\n")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('MMVG evaluation script', parents=[get_args_parser()])
