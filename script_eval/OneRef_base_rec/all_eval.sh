...
# Batch evaluation script: iterate over 3 datasets × 2 modalities (OneRef_base_rec, rgb/ir)
...
LOG_ROOT="./logs/eval/OneRef_base_rec"
mkdir -p "$LOG_ROOT"

for ds in $DATASETS; do
  for m in $MODALITIES; do
    echo -e "\n==================== [OneRef_base_rec] DATASET: $ds, MODALITY: $m ==========================="
