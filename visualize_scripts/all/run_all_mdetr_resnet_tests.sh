#!/bin/bash
# ===================== MDETR_resnet Comprehensive Test Script =====================
# Automatically test all dataset and modality combinations
# Usage: bash run_all_mdetr_resnet_tests.sh

echo "Starting MDETR_resnet comprehensive test..."
echo "Test scope:"
...
for dataset in "${DATASETS[@]}"; do
    for modality in "${MODALITIES[@]}"; do
        ...
        echo "   Output: ./visual_result/mdetr_resnet/$dataset/$modality"
        echo "----------------------------------------"
...
echo ""
echo "MDETR_resnet comprehensive test completed!"
echo "========================================"
...
echo "   - To modify sample count, edit NUM_SAMPLES in visualize_mdetr_resnet.sh"
