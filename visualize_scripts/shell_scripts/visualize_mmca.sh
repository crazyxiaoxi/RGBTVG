...
MODEL_CHECKPOINT="/home/xijiawen/code/rgbtvg/dataset_and_pretrain_model/result/MMCA/MMCA_224_rgb_mfad_best.pth"  # 修改为你的模型路径
...
# 可视化参数
OUTPUT_DIR="./visual_result/mmca_${DATASET}_${MODALITY}"
